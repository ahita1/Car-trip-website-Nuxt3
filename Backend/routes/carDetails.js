...
// const carDetails = require("../models/car/carPic");
// const carDetails = require("../models/car/carSpec");
// const carDetails = require("../models/driver/Driver");
...
router.post("/register", async (req, res) => {
  ...
  try {
    ...
    //   });
    // }
    const existCar = await carDetails.findOne({ carID });
    if (existCar) {
      return res.json({
        status: "bad",
    ...
    const newCar = await new carDetails({
      carName,
      carID,
      carType ,
      carModel , 
